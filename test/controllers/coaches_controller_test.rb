...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { email: @coach.email, firstName: @coach.firstName, lastName: @coach.lastName, telefonNumber: @coach.telefonNumber }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { email: @coach.email, firstName: @coach.firstName, lastName: @coach.lastName, telefonNumber: @coach.telefonNumber }
    assert_redirected_to coach_path(assigns(:coach))
  end
